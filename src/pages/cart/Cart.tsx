...
const Cart = () => {
  ...
  const [cartList, setCartListValue] = useState({
    ...
    totalAmount: '₹1212.00',
    itemList: [
      { imageSrc: '/images/vegetables.svg', title: 'Fresh Onion (500gm)', price: '₹60.00', quantity: 2 },
      { imageSrc: '/images/vegetables.svg', title: 'Fresh Onion (500gm)', price: '₹60.00', quantity: 1 },
      { imageSrc: '/images/vegetables.svg', title: 'Fresh Onion (500gm)', price: '₹60.00', quantity: 3 },
      { imageSrc: '/images/vegetables.svg', title: 'Fresh Onion (500gm)', price: '₹60.00', quantity: 1 },
      { imageSrc: '/images/vegetables.svg', title: 'Fresh Onion (500gm)', price: '₹60.00', quantity: 3 },
      { imageSrc: '/images/vegetables.svg', title: 'Fresh Onion (500gm)', price: '₹60.00', quantity: 2 },
    ]
        ...
        <>
          <div className="px-2 pt-20">
            <div className="flex justify-between items-center">
              ...
              <button className="border-primary border-2 bg-white text-primary rounded-md px-2 py-1 text-[11px] font-medium"
                onClick={() => {
                  navigate('/catalog')
                }}>
                Add More
            ...
            <div className="max-h-72 h-72 overflow-x-hidden overflow-y-scroll mt-4">
              {cartList.itemList.map((items: any, index: number) => (
                <CartCard
                  key={index}
                  className=""
                  imageCn="border-1 border-[#09215B]"
            ...
            <div className="flex justify-between text-[14px] font-semibold leading-6 mt-2">
              ...
              <div className="text-end">
                <span>{cartList.estimatedCost}</span><br />
            ...
            <div className="text-[12px] text-secondaryFontColor font-light mt-2">
              By continuing, you agree to share your cart and phone number with the business so it can confirm your order and total price including any tax and discounts.
            </div>
            <button className="bg-primary text-white text-[12px] py-2 font-light w-full my-3 rounded-md" onClick={() => {
              navigate('/catalog')
            }}>Send To Business</button>
          </div>
        </> :
        <>
          <div
