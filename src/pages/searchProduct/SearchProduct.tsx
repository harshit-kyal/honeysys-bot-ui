...
const SearchProduct = () => {
    ...
    const [recentSearchOptions, setRecentSearchOptions] = useState(['Fresh Tomatoes', 'Casual Shirt', 'Apparels', 'Watches', 'Car Care']);
    ...
    return (
        <div className=''>
            <div className='header flex items-center justify-evenly flex-shrink-0 px-1'>
                ...
                <div>
                    <input name='search' id='search' placeholder='What are you looking for?' onInput={(e: any) => {
                ...
                {searchStr ?
                    <>
                        <div className='flex text-[12px]'>
                            <span className='font-normal text-secondaryFontColor'>Showing results for "</span>
                    ...
                    <>
                        <span className='text-[12px] font-normal text-secondaryFontColor'>Are you looking for</span>
                        <div className='mt-2'>
                            {
                                recentSearchOptions.map((items: any, index: number) => (
                                    <>
                                        <div key={index} className='flex'>
                                            <img src='/images/searchBlack.svg' alt='searchblack' width={20} height={20}></img>
